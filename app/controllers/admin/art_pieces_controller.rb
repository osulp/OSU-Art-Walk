class Admin::ArtPiecesController < AdminController
  ...
  def index
    @art_pieces = ArtPieceDecorator.decorate_collection(ArtPiece.all.includes(:art_piece_photos))
  ...
  def art_piece_params
    params.require(:art_piece).permit(:title, :medium, :creation_date, :size, :legal_info, :private, :contact_info, :description, :displayed, :number, :series, :percent_for_art, :building, art_piece_photo_ids:[], art_piece_photos_attributes: [:photo, :id, :_destroy], art_piece_building_attributes: [:building_id, :art_piece_id, :id], artist_ids: [], collection_ids:[])
  end
end
